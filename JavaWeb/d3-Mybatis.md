...
![image-20210729111159534](/img/assets/image-20210729111159534.png)
...
* 安装 MyBatisX 插件
    ...
    * 插件效果
      ...
      ![image-20210729165337223](/img/assets/image-20210729165337223.png)

### 1.2  查询所有数据

<img src="/img/assets/image-20210729165724838.png" alt="image-20210729165724838" style="zoom:80%;" />
...
![image-20210729172544230](/img/assets/image-20210729172544230.png)
...
<img src="/img/assets/image-20210729180118287.png" alt="image-20210729180118287" style="zoom:80%;" />
...
* ${} ：拼接SQL。底层使用的是 `Statement`，会存在SQL注入问题。如下图将 映射配置文件中的 #{} 替换成 ${} 来看效果
  ...
  <img src="/img/assets/image-20210729184156019.png" alt="image-20210729184156019" style="zoom:70%;" />
...
* <![CDATA[内容]]>
  ...
  <img src="/img/assets/image-20210729185030318.png" alt="image-20210729185030318" style="zoom:60%;" />

### 1.4  多条件查询

![image-20210729203804276](/img/assets/image-20210729203804276.png)
...
* if 标签：条件判断
  ...
  ![image-20210729212510291](/img/assets/image-20210729212510291.png)
...
<img src="/img/assets/image-20210729213613029.png" alt="image-20210729213613029" style="zoom:80%;" />
...
<img src="/img/assets/image-20210729214917317.png" alt="image-20210729214917317" style="zoom:70%;" />
...
![image-20210729220348255](/img/assets/image-20210729220348255.png)
...
* 添加订单项数据，订单项中需要设置所属订单的id
  ...
  <img src="/img/assets/image-20210729221058898.png" alt="image-20210729221058898" style="zoom:80%;" />
...
<img src="/img/assets/image-20210729222642700.png" alt="image-20210729222642700" style="zoom:80%;" />
...
![image-20210729224205522](/img/assets/image-20210729224205522.png)

从结果中SQL语句可以看出，只修改了 `status`  字段值，因为我们给的数据中只给Brand实体对象的 `status` 属性设置值了。这就是 `set` 标签的作用。

### 1.8  删除一行数据

![image-20210729224549305](/img/assets/image-20210729224549305.png)
...
<img src="/img/assets/image-20210729225713894.png" alt="image-20210729225713894" style="zoom:70%;" />
...
* 运行程序则可以看到错误
  ...
  ![image-20210805231727206](/img/assets/image-20210805231727206.png)
...
![image-20210805234302849](/img/assets/image-20210805234302849.png)
